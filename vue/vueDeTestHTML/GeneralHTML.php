...
class GeneralHTML {
    ...
    public function afficheIndex(){
        ...
        ?>     
           ...
           <A href="do.php?action=affichageVoiture"> Affichage voiture </A> <BR/>
           <a href="do.php?action=afficheInsertionVoiture"> Insérer une voiture</a><BR/>
           <a href="do.php?action=afficheSuppressionVoiture"> Supprimer une voiture </a> <BR/>
        <?php
